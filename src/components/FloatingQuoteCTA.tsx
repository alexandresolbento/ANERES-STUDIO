...
import { MessageCircle, Sparkles, X, Instagram } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        {isOpen ? (
          <motion.div
            ...
            className="p-3 sm:p-3.5 rounded-2xl bg-zinc-950/95 border border-emerald-500/40 shadow-2xl backdrop-blur-md flex flex-col gap-2.5 max-w-[320px] sm:max-w-sm"
          >
            ...
            {/* Action Buttons: Pedir Orçamento Grátis + Instagram + Form */}
            <div className="flex items-center gap-2 w-full">
              <motion.a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-zinc-950 font-black text-xs sm:text-sm tracking-wide shadow-lg shadow-emerald-500/25 transition-colors cursor-pointer text-center"
              >
              ...
              <motion.a
                ...
                className="p-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-pink-400 hover:text-pink-300 transition-colors shrink-0 cursor-pointer"
              >
          ...
          <motion.button
            ...
            className="inline-flex items-center gap-2.5 px-3.5 py-2.5 rounded-full bg-zinc-950/95 border border-emerald-500/50 text-white text-xs font-bold shadow-xl hover:bg-zinc-900 transition-colors cursor-pointer group"
